...
extern bool   classicDivergence = true;
extern bool   hiddenDivergence = false;
//---- buffers
...
//----   
   if(classicDivergence && macd[currentTrough] > macd[lastTrough] && 
...
//----   
   if(hiddenDivergence && macd[currentTrough] < macd[lastTrough] && 
      Low[currentTrough] > Low[lastTrough])
     {
       bullishDivergence[currentTrough] = macd[currentTrough] - 
                                          arrowsDisplacement;
...
//----   
   if(classicDivergence && macd[currentPeak] < macd[lastPeak] && 
   ...
   if(hiddenDivergence && macd[currentPeak] > macd[lastPeak] && 
      High[currentPeak] < High[lastPeak])
     {
       bearishDivergence[currentPeak] = macd[currentPeak] + 
                                        arrowsDisplacement;
